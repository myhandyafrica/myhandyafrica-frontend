...
export default function Footer() {
    return (
        <footer className="bg-primary-900 text-white flex flex-col md:flex-row justify-center md:justify-between items-center gap-5 pt-[35px] pb-[20px] md:pb-[64px] px-[24px] md:px-[47px]">
