    ...
    <Layout>
      <form action="" className='text-primary-900 w-[255px] md:w-[450px] mx-auto lg:w-2/4' onSubmit={handleSubmit}>
        ...
        <div className="flex flex-col gap-[35px] mt-[24px]">
          <p className="text-[10px] md:text-[15px] lg:text-[20px] text-black">Please register to continue to <span className='font-bold hover:text-primary-100'>work</span> or click here to <Link href="/signup/hire" className='font-bold hover:text-primary-100'>REGISTER TO HIRE</Link></p>
