            ...
            <form action="" className='text-primary-900 w-[320px] md:w-[400px] mx-auto lg:w-2/4' onSubmit={handleSubmit}>
                ...
                <div className="flex flex-col gap-[35px] mt-[36px]">
                    ...
                    <input required
                        ...
                        type="text" className="px-[17px] py-[25px] border border-[#3D3D3D] rounded-[10px] text-[20px]" placeholder='Full name' />

                    <input required
                        onChange={(e) => { setUserDetails({ ...userDetails, email: e.target.value }) }}
                        type="email" className="px-[17px] py-[25px] border border-[#3D3D3D] rounded-[10px] text-[20px]" placeholder='Email' />

                    <input required
                        onChange={(e) => { setUserDetails({ ...userDetails, stateOfResidence: e.target.value }) }}
                        type="text" className="px-[17px] py-[25px] border border-[#3D3D3D] rounded-[10px] text-[20px]" placeholder='State of residence' />

                    <input required
                        onChange={(e) => { setUserDetails({ ...userDetails, phone: e.target.value }) }}
                        type="phone" className="px-[17px] py-[25px] border border-[#3D3D3D] rounded-[10px] text-[20px]" placeholder='Phone number ' />
                    ...
                    <button type='submit' className="px-[17px] py-[13px] border border-[#3D3D3D] font-[500] text-center rounded-[10px] text-[36px] text-black">Register</button>
